...
using static ScriptingLanguage.WUIActionParser;
using static ScriptingLanguage.WUIActionTokenizer;
        ...
        public void SetVariable(string[] path, object value) {
            ...
            if (path.Length == 1 && value is Action action) {
                ...
                Bind(path[0], (args) => {
                    ...
                    //Dictionary<object, string[]> _variableReferenceToPath = variableReferenceToPath;
                   ...
                   //variableReferenceToPath = _variableReferenceToPath;
                    return res;
                });
            }
